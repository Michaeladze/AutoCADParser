  ...
  while (curr !== 'EOF') {
    ...
    switch (curr.code) {
      ...
      case 93:
        ...
        var boundaryVertexCount = curr.value;
        //
        // bzuillsmith on 18 Feb 2019 Contributor
        //
        // I think this should this be boundaryVertexCount.
        //
        // Reply…

        // console.warn('===========start==============',scanner )
				var boundry = parseHatchVertices(boundaryVertexCount, scanner)
    ...
    while (curr !== 'EOF') {
      ...
      switch (curr.code) {
        case 10: // X
          ...
          //   continue;
          // }
          vertex.start.x = curr.value;
          vertexIsStarted = true;

        case 11:
          vertex.end.x = curr.value;

          break;
        case 20: // Y
          vertex.start.y = curr.value;

          break;
        case 21:
          vertex.end.y = curr.value;
          vertexIsFinished = true;
          break;
        case 72: // окончание набора координат
